...
<div class="all-user">
    @auth
        ...
        <form action="">
            <div class="mb-3 pt-0">
                <input type="email" placeholder="{{ Auth::user()->email }}" class="px-3 py-3 placeholder-blueGray-300 text-blueGray-600 relative bg-white bg-white rounded text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full"/>
            </div>
